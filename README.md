...
## 🚀 มีอะไรใหม่ในเวอร์ชัน 1.3.2 (Hotfix: Floating Modals & 3-Dot More Options Menu)
* **✨ เมนูสามจุด (...) ลอยเหนือหน้าเว็บแบบ Floating Child Modal:**
  * ยกระดับเมนูสามจุด (`MoreOptionsMenu`) สู่สถาปัตยกรรม **OS-Level Floating Window** ลอยอยู่เหนือ `WebContentsView` และวิดีโอ YouTube อย่างสมบูรณ์แบบ
  * แก้ไขปัญหาหน้าต่างเมนูจมหรือถูกบดบังอยู่หลังหน้าเว็บเมื่อคลิกปุ่มสามจุด
* **🪟 ระบบหน้าต่างลอยสมบูรณ์แบบ ปราศจากการบีบหน้าเว็บ (Zero Layout Shift):**
  * ปุ่มเครื่องมือทั้งหมดบนแถบ TopBar (ดาวน์โหลด, AdShield, ศูนย์ควบคุมสื่อ, ปรับระดับเสียงแยกแท็บ, เมนูตัวเลือกเพิ่มเติม) ทำงานเป็นหน้าต่างลอยทั้งหมด
  * หน้าเว็บรักษาความกว้าง 100% เต็มจอ ไม่มีการบีบหน้าเว็บหรือกระตุกสั่น
* **🎨 ดีไซน์ Glassmorphic พรีเมียม พร้อมคลิกด้านนอกเพื่อปิดอัตโนมัติ:**
  * ดีไซน์กระจกฝ้าโปร่งแสงล้ำสมัย สวยงาม ไร้กรอบเหลี่ยมแข็ง พร้อมเอฟเฟกต์แอนิเมชันเปิดปิดที่นุ่มนวล
...
* **⚙️ หน้าการตั้งค่าแบบเต็มแท็บ (`bocchy://settings`):**
  ...
  * มีเมนูหมวดหมู่ฝั่งซ้าย (การตั้งค่าทั่วไป, ภาษา & การแสดงผล, ความปลอดภัย & DNS, ประสิทธิภาพ & แรม, เกี่ยวกับ Bocchy) ใช้งานสะดวก กว้างขวาง สบายตา
* **✨ เมนูลอยสไตล์ Microsoft Edge (`...` More Options):**
  * เพิ่มปุ่ม `...` ที่แถบขวาบน พร้อมเมนูแบบลอยตัวตามตัวอย่าง Microsoft Edge รวบรวมฟังก์ชันจำเป็นครบครัน (ซูม `[-] 100% [+]`, แท็บใหม่, InPrivate, บุ๊กมาร์ก, ประวัติ, ดาวน์โหลด, ป้องกันโฆษณา, ดักจับมีเดีย, โหมดมืด, DevTools, ตั้งค่า)
* **📐 Zero-Compression Layout (ยกเลิกการบีบหดหน้าเว็บ):**
  * ยกเลิกการหดหน้าต่าง WebContentsView ด้านข้าง (`sidebarWidth = 0`) ทำให้เวลาเปิดดูหน้าต่างลอยต่าง ๆ วิดีโอ YouTube หรือเว็บอื่น ๆ จะไม่ถูกขยับหรือย่อขนาดให้เสียสายตาอีกต่อไป
* **🎀 ธีม Edge Vibrant Candy Pink & White Pill Omnibox:**
  * แถบด้านบนสีชมพู Candy Pink สดใส พร้อมช่อง URL แคปซูลสีขาวล้วนขนาดใหญ่ 36px อ่านง่าย ชัดเจน และสบายตา
* **🪟 ระบบจดจำขนาดและตำแหน่งหน้าต่าง (Window State Persistence):**
  * บันทึกขนาดหน้าต่าง พิกัด x, y และสถานะเต็มจอ (Maximize) อัตโนมัติเมื่อปิดแอพ พร้อมระบบป้องกันหน้าต่างหลุดจอกรณีถอดจอแยก

---

## 🛠️ มีอะไรใหม่ในเวอร์ชัน 1.1.1 (Hotfix)
* **🔍 แก้ไขหน้าต่าง Zoom หล่นไปอยู่หลังหน้าเว็บ:**
  * เปลี่ยนตัวควบคุม Zoom เป็น **Inline Stepper (`[-] 100% [+]`)** บน Navigation Bar โดยตรง ป้องกันปัญหาหน้าต่าง Zoom ตกไปอยู่หลังวิดีโอ YouTube หรือ WebContentsView
* **📋 แก้ไขแถบด้านบนจอดำและหน้าต่าง Update Log:**
  * เปลี่ยนหน้าต่าง Update Log เป็น **Right-Side Drawer** อัจฉริยะที่เลื่อนเนื้อหาหน้าเว็บหลบให้โดยอัตโนมัติ หมดปัญหาแถบด้านบนจอดำ และสามารถเปิดดู Update Log ควบคู่กับการดูวิดีโอ YouTube ได้ทันที
* **🔊 ปรับปรุงการควบคุมเสียงหัวแท็บ:**
  * เพิ่มการปรับระดับเสียงด่วนด้วยการ **หมุนล้อเมาส์ (Scroll Wheel)** บนไอคอนลำโพงที่หัวแท็บ และคลิกเพื่อ Mute/Unmute ทันที

---

## 🚀 มีอะไรใหม่ในเวอร์ชัน 1.1.0 (What's New in v1.1.0)
* **🔊 ระบบควบคุมเสียงแยกแท็บ (Per-Tab Audio & Volume Control):**
  * แสดงสัญลักษณ์คลื่นเสียง 🔊 อัตโนมัติเมื่อแท็บมีเสียงเล่น
  * คลิกที่ไอคอนลำโพงบนหัวแท็บเพื่อ Mute/Unmute ได้ทันที
  * มีสไลเดอร์ปรับความดังเสียง (0% - 100%) แยกอิสระในแต่ละแท็บ
* **🔍 ระบบย่อ-ขยายหน้าเว็บ (Page Zoom Controls):**
  * ซูมหน้าเว็บได้ตั้งแต่ 25% ถึง 500%
  * รองรับคีย์ลัดสากล `Ctrl + +`, `Ctrl + -`, และ `Ctrl + 0` เพื่อรีเซ็ตกลับ 100%
  * ปรับสเกลได้รวดเร็วผ่านตัวควบคุม Zoom บน Navigation Bar
* **🛠️ โหมดนักพัฒนา (Developer Mode & F12):**
  * เปิด DevTools ตรวจสอบหน้าเว็บ คอนโซล และการเชื่อมต่อเครือข่ายด้วยปุ่มลัด `F12` หรือ `Ctrl + Shift + I`
  * มีสวิตช์เปิด/ปิด Dev Mode ในการตั้งค่า พร้อมปุ่มเปิดเครื่องมือบนแถบนำทาง
* **📋 บันทึกประวัติการอัปเดต (Update Log Viewer):**
  * หน้าต่างแจ้งเตือนและดูบันทึกการเปลี่ยนแปลงของแต่ละเวอร์ชัน เข้าถึงได้ผ่านปุ่ม `v1.1.0` บนแถบเครื่องมือ
